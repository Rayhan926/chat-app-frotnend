...
const Message = (chat: Chat) => {
  ...
  if (isTyping) {
    return (
      ...
      >
        <div className="pb-3 pt-2.5 px-3 flex items-center justify-center gap-[3px] typing_dots_wrapper bg-dark-100 dark:bg-dark-mode-800 h-[34px] rounded-r-xl rounded-l-[2px]">
          <span></span>
          <span></span>
          <span></span>
        </div>
      ...
      <div
        ...
        className={cx(
          ...
          isMe
            ...
            : 'bg-dark-100 text-dark-900 dark:bg-dark-mode-800 dark:text-white rounded-r-xl rounded-l-[2px]',
        )}
      >
        ...
        >
          ...
          <span
            className={cx(
              ...
              !isMe
                ? 'text-dark-800 dark:text-dark-mode-200 rounded-br-[10px]'
                : 'rounded-bl-[10px]',
              !message
